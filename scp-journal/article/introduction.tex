...
$s$, test cases for trace refinement check for illegal acceptance of a
...
because trace refinement and correctness of nondeterministic behaviour are
...
checking trace refinement are a simplified version of the former class; they
