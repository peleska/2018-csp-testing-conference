...
internal choice is not defined for an empty index set. \fixme{alcc: Note the
difference to internal choice. I think this is not a problem here.}
...
Therefore, using the conformance relation $conf$ 
