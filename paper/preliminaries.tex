...
$\minaccs(G(Q)/s)$, a contradiction to Assumption~2. We note that we use
...
section. This completes the proof of the lemma. \fixme{Please, check that
you're happy with this observation.}\xbox
\end{proof}
%
