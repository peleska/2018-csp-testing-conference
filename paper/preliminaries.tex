...
%relation called $conf$ and defined below. The set 
%$\refs(P,t) \defs \{~X | (t,X) \in \fails(P)~\}$ used in this
%definition contains the refusals of $P$ after the
%trace $t$.
%%
%\begin{displaymath}
%  Q\ conf\ P \defs \forall t: \trc(P) \cap \trc(Q) @ \refs(Q,t)
%  \subseteq \refs(P,t)
%\end{displaymath}
%%
...
%  \\ & & \forall s\in\trc(G(Q)), R_Q\in r_Q(G(Q)/s):  \nonumber
%  \\ & & \tabd
%  \exists R_P\in r_P(G(P)/s): R_Q\subseteq R_P
%  \\
%  \label{eq:failrefb}
...
%corresponding smaller set of acceptances in $P$.
