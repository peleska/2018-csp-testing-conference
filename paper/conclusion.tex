...
Lemma~\ref{lemma:hseta}. \fixme{alcc: my guess is that these complete tests
are not for refinement. I think we can perhaps say something about this?}
...
failure. \fixme{alcc: if deadlock is not acceptable? I think you need
