...
\fxnote{jp: Here, the hiding operator is not necessary: the possible test executions are really the traces of $Q$ parallel $U_T(j)$. The hiding is only needed to specify the verdict.}  
