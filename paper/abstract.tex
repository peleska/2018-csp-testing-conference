...
It is shown that the test suites are optimal with respect to two aspects:  (a)  the maximal length of test traces cannot be reduced, and (b) the nondeterministic behaviour cannot be tested with smaller or fewer sets of events, without losing the test suite's completeness property. \fixme{alcc: Is the technique
applying the test suites?}
\fxnote{jp: this sentence needed to be re-phrased -- the new version should be better understandable}
