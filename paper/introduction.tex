...
requires a more complex approach to testing for conformity in the
failures-model than required for model-based testing against nondeterministic
FSMs, as published, for example,
