...
\newcommand{\accs}{\text{Acc}}
\newcommand{\minaccs}{\text{minAcc}}
...
%
\author{
Ana Cavalcanti\inst{1} \and  Wen-ling Huang\inst{2} \and Jan Peleska\inst{2}
\and Adenilso Simao\inst{3}
}
%
\authorrunning{Cavalcanti, Huang, Peleska, and Simao}
